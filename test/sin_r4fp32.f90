program test
  ...
  exit_code = sin_r4fp32()
  stop exit_code

contains

integer function sin_r4fp32() result(r)
  use FEQParse
  use iso_fortran_env
  implicit none
  ...
  do l = 1,M
    ...
    do j = 1,N
      do i = 1,N
       fexact(i,j,k,l) = sin(2.0_real32*pi*x(i,j,k,l,1))*sin(2.0_real32*pi*x(i,j,k,l,2))*sin(2.0_real32*pi*x(i,j,k,l,3))
      end do
    end do
    end do
  end do
