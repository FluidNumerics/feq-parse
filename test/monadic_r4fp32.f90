program test
  ...
  exit_code = monadic_r4fp32()
  stop exit_code

contains

integer function monadic_r4fp32() result(r)
  ...
  do l = 1,M
    ...
    do j = 1,N
      do i = 1,N
        fexact(i,j,k,l) = -(x(i,j,k,l,1) + 1.0_real32)*(x(i,j,k,l,2) + 1.0_real32)*(x(i,j,k,l,3) + 1.0_real32)
      end do
    end do
    end do
  end do
